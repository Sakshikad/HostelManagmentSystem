                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="studname" name="studname" value="<?php echo $row1['studname']; ?>" readonly="true">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Date: </label>
                                                    <input type="text" class="form-control" name="date" value="<?php echo $row1['created_at']; ?>" readonly="true">
                                                </div>
                                            </div>
                                        </div>
